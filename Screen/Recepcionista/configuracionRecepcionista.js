...
import { eliminarCuentaRecepcionista } from "../../Src/Service/RecepcionService";


export default function configuracionRecepcionista({ setUserToken }) {
    ...
    const handleDeleteAccount = async () => {
        ...
        try {
            const result = await eliminarCuentaRecepcionista(); 
    ...
    const handleOptionPress = (action) => {
        if (action === "changePassword") {
            navigation.navigate("CambiarContrasenaRecepcionista");
