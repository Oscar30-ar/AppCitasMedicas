...
const API_BASE_URL = `http://10.2.234.177:8000/api`;
// const API_BASE_URL = `https://nonbiologically-econometric-charlee.ngrok-free.dev/api`;
...
const RutasPublicas = ['/login', '/registrar', '/registrarPaciente', '/listarEpsPublico'];
